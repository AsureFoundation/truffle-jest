...
class TruffleEnvironment extends NodeEnvironment {
  async setup() {
    ...
    this.global.__truffleTest = await TruffleTest.create(getTmpDir());
    ...
    this.global.contract = (name, body) => {
      this.global.describe(name, () => {
        body(this.global.accounts, this.global.web3)
      })
    };
